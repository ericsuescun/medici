class TrialCitiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @trial_city.save
        format.html { redirect_to @trial_city, notice: "Trial city was successfully created." }
  ...
  def update
    respond_to do |format|
      if @trial_city.update(trial_city_params)
        format.html { redirect_to @trial_city, notice: "Trial city was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to trial_cities_path, status: :see_other, notice: "Trial city was successfully destroyed." }
  ...
  private
    ...
    def set_trial_city
      @trial_city = TrialCity.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def trial_city_params
      params.expect(trial_city: [ :studies_id, :name ])
    end
end
