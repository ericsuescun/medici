class TrialCenterBranchesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @trial_center_branch.save
        format.html { redirect_to @trial_center_branch, notice: "Trial center branch was successfully created." }
  ...
  def update
    respond_to do |format|
      if @trial_center_branch.update(trial_center_branch_params)
        format.html { redirect_to @trial_center_branch, notice: "Trial center branch was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to trial_center_branches_path, status: :see_other, notice: "Trial center branch was successfully destroyed." }
  ...
  private
    ...
    def set_trial_center_branch
      @trial_center_branch = TrialCenterBranch.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def trial_center_branch_params
      params.expect(trial_center_branch: [ :name, :initials, :description, :trial_center_facility_id ])
    end
end
