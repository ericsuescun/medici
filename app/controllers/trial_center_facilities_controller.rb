class TrialCenterFacilitiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @trial_center_facility.save
        format.html { redirect_to @trial_center_facility, notice: "Trial center facility was successfully created." }
  ...
  def update
    respond_to do |format|
      if @trial_center_facility.update(trial_center_facility_params)
        format.html { redirect_to @trial_center_facility, notice: "Trial center facility was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to trial_center_facilities_path, status: :see_other, notice: "Trial center facility was successfully destroyed." }
  ...
  private
    ...
    def set_trial_center_facility
      @trial_center_facility = TrialCenterFacility.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def trial_center_facility_params
      params.expect(trial_center_facility: [ :name, :initials, :email, :description, :contact_number, :contact_address, :url ])
    end
end
