class SponsorsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to sponsors_path, status: :see_other, notice: "Sponsor was successfully destroyed." }
  ...
  private
    ...
    def sponsor_params
      params.expect(sponsor: [ :name, :intials, :shortname, :sponsor_type ])
    end
end
