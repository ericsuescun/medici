...
class StudiesTest < ApplicationSystemTestCase
  ...
  test "should create study" do
    ...
    fill_in "Medical preexistencies", with: @study.medical_preexistencies
    ...
    fill_in "Registrated at", with: @study.registrated_at
    ...
    fill_in "Sponsors", with: @study.sponsors_id
